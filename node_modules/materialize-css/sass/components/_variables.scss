...
$secondary-color: color("deep-purple", "base") !default;
$success-color: color("pale-goldenrod", "base") !default;
$error-color: color("crimson", "base") !default;
$link-color: color("deep-koamaru", "base") !default;
